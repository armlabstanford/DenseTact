...
class NeRFRenderer(nn.Module):
    ...
    def run(self, rays_o, rays_d, num_steps=128, upsample_steps=128, 
        ...
        fars.unsqueeze_(-1)
        #print()
        #print("Printing all the statements in the renderer.py file in the run definition")
        #print()
        #print(min_near)
        #print("AABB")
        #print(aabb)
        ...
        #print("===================================================================================================================")
        #print("PRINTING DEPTH: ", depth)
        #print("PRINTING IMAGE: ", image)
        #print("PRINTING IMAGE_VAR: ", image_var)
        #print("PRINTING D_VAR: ", d_var)
        #print()
        #sys.exit()
