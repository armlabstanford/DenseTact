...
class NeRFGUI:
    def __init__(self, opt, trainer, train_loader=None, debug=True):
        ...
        print("Checking the value of train_loader in GUI.py file: ", self.train_loader)

        if train_loader is not None:
            print("Want to see if train loader is None: ", self.train_loader)
            err_dict = {}
        ...
        self.register_dpg()
        self.test_step()
        print("================Finished defining the INIT function in the NeRFGUI class=================")
    ...
    def train_step(self):
        print("Inside the train_step function in the GUI.py file....")    
        starter, ender = torch.cuda.Event(enable_timing=True), torch.cuda.Event(enable_timing=True)
        starter.record()
        print("Started training the NeRF....")
        ...
        print("Printing the training step number: ")

        self.step += self.train_steps
        self.need_update = True

        dpg.set_value("_log_train_time", f'{t:.4f}ms')    # dpg means dearpy gui
    ...
    def render(self):
        ...
        while dpg.is_dearpygui_running():
            ...
            if self.training:
                print("Going to call the training function: train_step()")
                self.train_step()
            self.test_step()
